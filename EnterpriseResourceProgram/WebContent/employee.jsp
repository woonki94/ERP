			...
			for(EmployeeDTO dto:list){
			 %>
			    <tr align="center">
			      ...
			      <td><button class="btn btn-danger btn-xs" name="button" onclick="idDelete('<%=dto.getEID() %>')">삭제</button></td>
			      <td><button type="button" class="btn btn-warning btn-xs btnUp"  data-toggle="modal" data-target='#editEmployeeModal' value=<%=dto.getEID() %>>수정</button></td>
